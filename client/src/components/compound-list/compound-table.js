...
function createData(name, mass, profile) {
  return { name, mass, profile };
}

const rows = [
  createData('Benzene', 69, "H3O"),
  createData('Benzene', 69, "H3Om"),
  createData('Acetone', 59, "H3O"),
  createData('MVK', 69, "H3O"),
];
